...
def inference():
  ...
  #   input_image = tf.image.resize_images(input_image, size=(FLAGS.image_size_inference, FLAGS.image_size_inference))
  #   input_image = utils.convert2float(input_image)
  #   input_image.set_shape([FLAGS.image_size_inference, FLAGS.image_size_inference, 3])
